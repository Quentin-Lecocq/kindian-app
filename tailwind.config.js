  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        'roboto-mono-thin': ['Roboto-Mono-Thin', 'sans-serif'],
        'roboto-mono-extra-light': ['Roboto-Mono-ExtraLight', 'sans-serif'],
        'roboto-mono-light': ['Roboto-Mono-Light', 'sans-serif'],
        'roboto-mono': ['Roboto-Mono-Regular', 'sans-serif'],
        'roboto-mono-medium': ['Roboto-Mono-Medium', 'sans-serif'],
        'roboto-mono-semi-bold': ['Roboto-Mono-SemiBold', 'sans-serif'],
        'roboto-mono-bold': ['Roboto-Mono-Bold', 'sans-serif'],
      },
      colors: {
        'primary': '#F57230',
        'secondary': '#FFEFD7',
